...
Replace World for something else and see what happens.

Note: twisted requires Python sources, which must be installed using `sudo apt-get install python-dev`
